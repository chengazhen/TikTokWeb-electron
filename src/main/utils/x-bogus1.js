...
function _0x478bb3(l, n, u) {
  ...
  let r = e | t | u
  return (
    _0x377d66[(16515072 & r) >> 18] +
    _0x377d66[(258048 & r) >> 12] +
    _0x377d66[(4032 & r) >> 6] +
    _0x377d66[63 & r]
  )
}
...
function _0x330d112(l, n) {
  ...
  for (; d < n.length; d++) {
    ;(t = (t + e[(a = (a + 1) % 256)]) % 256),
      ...
      (e[a] = e[t]),
      (e[t] = u),
      (r += String.fromCharCode(n.charCodeAt(d) ^ e[(e[a] + e[t]) % 256]))
  }
  return r
}
...
function getXB(l) {
  ...
  //unescape('%FF')
  let i = _0x33baa6.apply(null, [
    2,
    255,
    _0x330d112.apply(null, [
      String.fromCharCode(255),
      _0x330d11.apply(null, o.concat(d).slice(0, 19))
    ])
  ])
